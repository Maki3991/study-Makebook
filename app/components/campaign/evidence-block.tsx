    ...
    <section className="section">
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          {address ? <span className="num text-micro text-ink">{address}</span> : null}
          <button
            type="button"
            onClick={handleCopy}
      ...
      <h3 className="mt-6 text-body font-medium text-ink">
        {copy.campaign.evidence.activityTitle}
      </h3>
      {activity.data === undefined ? (
        <p className="mt-2 text-body text-ink-3">{copy.product.manifestLoading}</p>
